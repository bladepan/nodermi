  ...
  Decoder = (function() {
    ...
    Decoder.prototype._decodeFunction = function(obj) {
      ...
      func = (function(source, funcId, server) {
        return function() {
          return server._invokeRemoteFunc(source, funcId, arguments);
        };
    ...
    Decoder.prototype._decodeObj = function(obj) {
      ...
      if (functions != null) {
        ...
        for (_i = 0, _len = functions.length; _i < _len; _i++) {
          funcName = functions[_i];
          func = (function(source, objId, funcName, server) {
            return function() {
              return server._invokeRemoteMethod(source, objId, funcName, arguments);
            };
          })(source, objId, funcName, server);
