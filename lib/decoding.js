(function() {
  ...
  var Decoder = (function() {
    ...
    Decoder.prototype._decode = function(obj) {
      ...
      if (util.isArray(obj)) {
        var result = [];
        lodash.forEach(obj, lodash.bind(function(item){
    ...
    Decoder.prototype._decodeArray = function(obj) {
      ...
      lodash.forEach(arrayElements, lodash.bind(function(element){
    ...
    Decoder.prototype._decodeSimple = function(obj) {
      ...
      if (properties != null) {
        lodash.forEach(properties, lodash.bind(function(prop){
