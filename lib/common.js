...
var logger = debug('nodermi:common');
...
// Ignore null when stringify
function ignoreNullReplacer(key, value) {
  if (value == null) {
    return undefined;
  }
  return value;
...
// convert object to json string, all null properties are ignored
exports.toJsonString = function (obj) {
  return JSON.stringify(obj, ignoreNullReplacer);
};
