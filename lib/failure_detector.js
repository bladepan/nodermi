...
function FailureDetector(options){
    if (options.server == null) {
        throw new Error("should pass server to fd.");
    }
    //load options
    lodash.defaults(this, options, {
        // ping every 1 minute by default
...
lodash.assign(FailureDetector.prototype, {
    ...
    // for test only
    _isServerActive : function(host){
        return this.hostMap[host] != null;
    }
});
