...
(function() {
  ...
  HttpTransport = (function(_super) {
    ...
    function HttpTransport(server) {
      ...
      this.host = server.host, this.port = server.port, this.fileLogger = server.fileLogger;
      this.server = express();
    ...
    HttpTransport.prototype.send = function(destination, message, callback) {
      var reqOption;
      this.fileLogger.log(this.fileLogger.enabled ? "Send message \n " + (JSON.stringify(message)) : void 0);
      reqOption = {
